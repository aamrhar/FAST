classdef FT_SDAR
    ...
    methods
        function obj=FT_SDAR(sdar,ref_data,mgs,fpga,info,luts)
            
            % set logger
            obj.L=log4m.getLogger2('FT_SDAR.log');
            obj.L.setFilename('FT_SDAR.log');
            obj.L.setLogLevel(obj.L.ALL);
            obj.L.info('init','FT_SDAR created')
            obj.sdar=sdar;
            ...
            if sum(isprop(obj.mgs,'data'))>0
                ...
                obj.L.warn('init','FT_SDAR no MGS found')
            end
            %set defaults
        ...
        function fig=plot_gps_3Dtrajectory(obj)
            ...
            [utc,lon,lat,alt]= obj.ref_data.get_position();
            plot3(lon,lat,alt,...
        ...
        function mark_mgs(obj)
            % add MGS
            if isprop(obj.mgs(1),'info')&& isstruct(obj.mgs(1).info)
